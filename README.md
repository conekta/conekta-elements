...
```kotlin
dependencies {
    implementation("io.conekta:conekta-elements-compose:0.0.1-beta.7")
}
```
...
```kotlin
dependencies {
    implementation("io.conekta:conekta-elements-shared:0.0.1-beta.7")
}
```
...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            checksum: "61dbdc8293007fe78c9a962a1e505e236b14ef2e69dbb14378390d95ae52f164"
        ),
        .target(
            name: "YourTarget",
